...
if ChatOpenAI is not None:
    class ChatOpenAIWithReasoning(ChatOpenAI):  # type: ignore[misc,valid-type]
        ...
        def _create_chat_result(self, response, generation_info=None):  # type: ignore[override]
            ...
            # bobdong.cn and other proxy APIs sometimes return a string or an
            # unexpected type. Guard against AttributeError when extracting
            # reasoning_content — silently skip if we can't parse it.
            try:
